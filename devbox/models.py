...
class RecycleBins(models.Model):
    deletedFolderID = models.ForeignKey(
        Folder, on_delete=models.CASCADE, related_name="deleted_folder", null=True, blank=True)
    deletedFileID = models.ForeignKey(
        Files, on_delete=models.CASCADE, related_name="deleted_files", null=True, blank=True)
